...
// MARK: - Core Status Models (Ported from EasyTier-iOS)
...
struct EasyTierStatus: Codable {
    enum NATType: Int, Codable, Hashable {
        ...
        var description: String {
            ...
            case .symUDPFirewall:   return "Symmetric UDP Firewall"
            case .symmetricEasyInc: return "Symmetric Easy Inc"
            case .symmetricEasyDec: return "Symmetric Easy Dec"
            }
        }
    }

    struct UUID: Codable, Hashable, CustomStringConvertible {
        var part1: UInt32
        var part2: UInt32
        var part3: UInt32
        var part4: UInt32
        ...
        var description: String {
            return String(format: "%08x-%08x-%08x-%08x", part1, part2, part3, part4)
        }
    }
    ...
    struct NodeInfo: Codable, Hashable {
        struct IPList: Codable, Hashable {
